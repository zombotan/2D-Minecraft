...
class Renderer:
	def __init__(self,screen):
		...
		self.display_surf = pygame.Surface((640,360))
	...
	def run(self,dt):
		...
		self.tileset.render(self.display_surf, offset=render_scroll)
		self.crosshair.crosshair(pygame.mouse.get_pos(), self.display_surf, offset=render_scroll)
		self.all_sprites.update(dt,self.tileset)
